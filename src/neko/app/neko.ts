...
const SPRITE_GAP = 1;
// const BACKGROUND_TARGET_COLOR = [234, 224, 213] as [number, number, number];
...
export class Neko {
  ...
  constructor({
    ...
    this.isFollowing = startFollowing || false;
  ...
  async createNekoElement() {
    ...
    this.nekoElement.style.right = `${this.posX - NEKO_HALF_WIDTH}px`;
    ...
    try {
      ...
      const transparentImageUrl = this.nekoImageUrl;
